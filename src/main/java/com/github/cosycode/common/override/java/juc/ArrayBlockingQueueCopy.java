...
/**
 * java.util.concurrent.ArrayBlockingQueue 的副本
 *
 * <p>和 java.util.concurrent.ArrayBlockingQueue 的区别是其中的几个变量从 private 改为了 protected, 便于继承</p>
 * <p>
...
class ArrayBlockingQueueCopy<E> extends AbstractQueue<E>
    ...
    /**
     * Creates an {@code ArrayBlockingQueueCopy} with the given (fixed)
     * capacity and default access policy.
     *
     * @param capacity the capacity of this queue
     * @throws IllegalArgumentException if {@code capacity < 1}
     */
    public ArrayBlockingQueueCopy(int capacity) {
        this(capacity, false);
    }
     ...
     * @throws IllegalArgumentException if {@code capacity < 1}
     */
    public ArrayBlockingQueueCopy(int capacity, boolean fair) {
        if (capacity <= 0)
    ...
    /**
     * Iterator for ArrayBlockingQueueCopy.
     * <p>
    ...
    private class Itr implements Iterator<E> {
        ...
        Itr() {
            ...
            lastRet = NONE;
            final ReentrantLock lock = ArrayBlockingQueueCopy.this.lock;
            lock.lock();
            try {
                if (count == 0) {
                    // assert itrs == null;
                    ...
                    final int takeIndex = ArrayBlockingQueueCopy.this.takeIndex;

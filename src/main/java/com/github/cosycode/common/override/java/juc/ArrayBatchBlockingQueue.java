 ...
 **/
public class ArrayBatchBlockingQueue<E> extends AbstractQueue<E>
    ...
    /**
     * Creates an {@code ArrayBatchBlockingQueue} with the given (fixed)
    ...
    /**
     * Iterator for ArrayBatchBlockingQueue.
     *
